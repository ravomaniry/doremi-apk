...
import mg.maniry.doremii.editor.partition.Note;
...
public class MidiTrack {
    ...
    private void readTrackData(byte[] data) throws IOException {
        ...
        while (in.available() > 0) {
            ...
            // edited
            // after being read in from getFileFromName.
    ...
    public void insertNote(Note note) {
        this.insertNote(note.getChannel(), note.getPitch(), note.getVelocity(), note.getTick(), note.getDuration());
    }
