...
import mg.maniry.doremi.ui.views.ChangesDialog
import mg.maniry.doremi.R
import mg.maniry.doremi.R.id.*
import mg.maniry.doremi.partition.ChangeEvent
...
class ChangesDialogManager(
    ...
    private fun observe() {
        editorViewModel.dialogOpen.observe(mainContext as MainActivity, Observer {
            try {
                if (it == true) {
